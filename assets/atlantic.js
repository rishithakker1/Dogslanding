...
var CartMini_CartMini = /*#__PURE__*/function () {
  ...
  CartMini_createClass(CartMini, [{
    ...
    value: function open() {
	  ...
	  // GR - 1 Mar '21 - Mini Cart -- Countdown
                                                                       
	  setTimeout(function () {
		var timerEl = document.querySelector("[data-cart-clock]");
		...
		var quantity_inputs = document.querySelectorAll(".cart_mini__qty");
        
		quantity_inputs.forEach(input => {
            input.addEventListener("click", () => { 
			setTimeout(function () {
              document.querySelector("[data-cart-mini-toggle]").click()
            }, 300);
          });
		});
...
// 	GR - 1 Mar '21 - LIVE SEARCH ENABLED/DISABLED
